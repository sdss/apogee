...
;
; PURPOSE:
;   Compute correction term to add to velocities to convert to barycentric.
;
; CALLING SEQUENCE:
;   vcorr = barycentric( ra, dec, [ epoch, jd=, tai=, $
...
;   05-Jul_2010  Renamed by D.Nidever
;-
;------------------------------------------------------------------------------

function barycentric, ra, dec, epoch, jd=jd, tai=tai, $
 longitude=longitude, latitude=latitude, altitude=altitude 
   ...
   AP_CT2LST, LST, longitude, junk, jd
   ...
   ; WE NEED TO ADD THE BARYCENTRIC VELOCITY TO THE OBSERVED VELOCITY
   ;  to get the correct RV
   ;return, (-vbarycen + vrotate)   ; WRONG SIGN
   return, (vbarycen - vrotate)    ; CORRECT SIGN
end
