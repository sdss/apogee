...
!  compile with Fortran 90 or 95  
      ...
      parameter (ndp=200)
      parameter (nfile=11)
      logical :: verif,check,test,extrapol,binary,optimize,fracinput
...
****** check number of layer, reference optical depth, and geometry compatibility ******
      ...
      do file=1,10
       ...
       read(*,*) z_ref
       read(*,*) test
       read(*,*) fracinput, teffpoint, loggpoint, metpoint
       read(*,*) optimize
...
********* calculation of the interpolation point(x,y,z) in {Teff,logg,z} space******************
     ...
     &  xkapref(ndepth_ref,nfile))
       ...
       if (.not. fracinput) then
         ...
         write(*,*) teffpoint, loggpoint, metpoint
