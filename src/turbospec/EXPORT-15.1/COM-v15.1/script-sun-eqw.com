...
#
# This script computes equivalent width for all the lines of the line list
# within the specified wavelenth interval. It treats each line of the line
# list as a single line. It cannot calculate eqw with hyperfine structure,
# or for a blend
#
...
set METALLIC   = '     0.000'
set TURBVEL    = '1.0'
set SUFFIX     = _${lam_min}-${lam_max}_xit${TURBVEL}.eqw
