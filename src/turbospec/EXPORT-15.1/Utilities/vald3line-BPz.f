...
* FORTRAN does not recognize comma as a delimiter, confirm fixed read format:
     ...
     &       .and.string(63:63).eq.','.and.string(70:70).eq.','
     &       .and.string(77:77).eq.','.and.string(84:84).eq.','
     &       .and.string(91:91).eq.','.and.string(98:98).eq.','
     &        ) then
